/* 祖影 Zuying marketing site — i18n (6 languages, matching the app) +
...
const I18N = {
  zh: {
    docTitle: '祖影 — 把家族的故事留下来',
    brand: '祖影', brandShort: '祖影',
    ...
    feat8T: '史册里的家族',
    feat8B: '内置两棵真实的家族树：孔子七十九代、伊丽莎白二世。打开就知道一棵长成的树是什么样子。',
    feat9T: '一份文件，就是整棵树',
    feat9B: '一份 .zuying 文件就是整棵树 —— 照片、录音、故事全在里面。隔空投送给家人，他打开就是完整的一棵；文件在你自己手里，想备份到哪里都行。',
    demoTitle: '在这里先试一试',
    ...
    regionsNowLabel: '已上架',
    regionsNow: 'iPhone 版已在 13 个国家和地区的 App Store 上架：中国大陆、香港、澳门、台湾、美国、加拿大、日本、印度、新加坡、马来西亚、印尼、菲律宾、泰国。',
    regionsNextLabel: '接下来',
    regionsNext: 'Android 版正在封闭测试，之后上架 Google Play；地区上还会加英国、澳洲和欧盟。',
    ctTitle: '联系我们',
    ctSub: '想法、建议、想第一时间试用？写封邮件给我们。',
    ctNote: '我们会认真读每一封来信。',
    footer: '© 2026 祖影 · 把家族的故事留下来',
    styles: { soft: '晨白', glass: '夜潮', candy: '暖橘', paper: '雅纸' },
  },

  zh_Hant: {
    docTitle: '祖影 — 把家族的故事留下來',
    brand: '祖影', brandShort: '祖影',
    ...
    feat8T: '史冊裡的家族',
    feat8B: '內建兩棵真實的家族樹：孔子七十九代、伊莉莎白二世。打開就知道一棵長成的樹是什麼樣子。',
    feat9T: '一份檔案，就是整棵樹',
    feat9B: '一份 .zuying 檔案就是整棵樹 —— 照片、錄音、故事全在裡面。用 AirDrop 傳給家人，他打開就是完整的一棵；檔案在你自己手裡，想備份到哪裡都行。',
    demoTitle: '在這裡先試一試',
    ...
    regionsNowLabel: '已上架',
    regionsNow: 'iPhone 版已在 13 個國家和地區的 App Store 上架：中國大陸、香港、澳門、台灣、美國、加拿大、日本、印度、新加坡、馬來西亞、印尼、菲律賓、泰國。',
    regionsNextLabel: '接下來',
    regionsNext: 'Android 版正在封閉測試，之後上架 Google Play；地區上還會加英國、澳洲和歐盟。',
    ctTitle: '聯絡我們',
    ctSub: '想法、建議、想第一時間試用？寫封郵件給我們。',
    ctNote: '我們會認真讀每一封來信。',
    footer: '© 2026 祖影 · 把家族的故事留下來',
    styles: { soft: '晨白', glass: '夜潮', candy: '暖橘', paper: '雅紙' },
  },

  en: {
    docTitle: 'Zuying — Keep your family’s story',
    brand: 'Zuying', brandShort: 'Zuying',
    ...
    feat8B: 'Two real family trees are built in: seventy-nine generations of Confucius, and Elizabeth II. Open one and see what a grown tree looks like.',
    feat9T: 'One file is the whole tree',
    feat9B: 'One .zuying file is the entire tree — photos, recordings and stories inside it. AirDrop it to a relative and they open a complete copy; the file is yours, to keep wherever you keep things.',
    ...
    regionsNowLabel: 'Out now',
    regionsNow: 'On iPhone in 13 countries and regions: mainland China, Hong Kong, Macau, Taiwan, the US, Canada, Japan, India, Singapore, Malaysia, Indonesia, the Philippines and Thailand.',
    regionsNextLabel: 'Next',
    regionsNext: 'Android is in closed testing and heads to Google Play next, along with the UK, Australia and the EU.',
    ctTitle: 'Contact us',
    ctSub: 'Ideas, feedback, or want to be first to try it? Drop us an email.',
    ctNote: 'We read every message.',
    footer: '© 2026 Zuying · Keep your family’s story',
    styles: { soft: 'Soft Minimal', glass: 'Aurora Glass', candy: 'Warm Playful', paper: 'Heritage' },
  },

  es: {
    docTitle: 'Zuying — Guarda la historia de tu familia',
    brand: 'Zuying', brandShort: 'Zuying',
    ...
    feat8B: 'Dos árboles genealógicos reales vienen incluidos: setenta y nueve generaciones de Confucio e Isabel II. Abre uno y verás cómo es un árbol ya crecido.',
    feat9T: 'Un archivo es el árbol entero',
    feat9B: 'Un archivo .zuying es el árbol entero: fotos, grabaciones e historias incluidas. Envíalo por AirDrop a un familiar y abrirá una copia completa; el archivo es tuyo, para guardarlo donde quieras.',
    ...
    regionsNowLabel: 'Ya disponible',
    regionsNow: 'Para iPhone en 13 países y regiones: China continental, Hong Kong, Macao, Taiwán, Estados Unidos, Canadá, Japón, India, Singapur, Malasia, Indonesia, Filipinas y Tailandia.',
    regionsNextLabel: 'Después',
    regionsNext: 'La versión para Android está en pruebas cerradas y llegará después a Google Play, junto con Reino Unido, Australia y la Unión Europea.',
    ctTitle: 'Contacto',
    ctSub: '¿Ideas, sugerencias o quieres ser de los primeros en probarla? Envíanos un correo.',
    ctNote: 'Leemos cada mensaje.',
    footer: '© 2026 Zuying · Guarda la historia de tu familia',
    styles: { soft: 'Soft Minimal', glass: 'Aurora Glass', candy: 'Warm Playful', paper: 'Heritage' },
  },

  fr: {
    docTitle: 'Zuying — Gardez l’histoire de votre famille',
    brand: 'Zuying', brandShort: 'Zuying',
    ...
    feat8B: 'Deux arbres généalogiques réels sont inclus : soixante-dix-neuf générations de Confucius et Élisabeth II. Ouvrez-en un pour voir à quoi ressemble un arbre déjà grand.',
    feat9T: "Un fichier, c'est tout l'arbre",
    feat9B: "Un fichier .zuying, c'est l'arbre entier — photos, enregistrements et récits compris. Envoyez-le par AirDrop à un proche : il ouvre une copie complète. Le fichier vous appartient, à conserver où vous voulez.",
    ...
    regionsNowLabel: 'Déjà disponible',
    regionsNow: 'Sur iPhone dans 13 pays et régions : Chine continentale, Hong Kong, Macao, Taïwan, États-Unis, Canada, Japon, Inde, Singapour, Malaisie, Indonésie, Philippines et Thaïlande.',
    regionsNextLabel: 'Ensuite',
    regionsNext: 'La version Android est en test fermé et arrivera ensuite sur Google Play, avec le Royaume-Uni, l’Australie et l’Union européenne.',
    ...
    footer: '© 2026 Zuying · Gardez l’histoire de votre famille',
    styles: { soft: 'Soft Minimal', glass: 'Aurora Glass', candy: 'Warm Playful', paper: 'Heritage' },
  },

  hi: {
    docTitle: 'Zuying — अपने परिवार की कहानी संजोएँ',
    brand: 'Zuying', brandShort: 'Zuying',
    ...
    feat8B: 'दो असली वंशवृक्ष पहले से मौजूद हैं: कन्फ़्यूशियस की उन्यासी पीढ़ियाँ और एलिज़ाबेथ द्वितीय। एक खोलिए और देखिए कि पूरा बड़ा हुआ पेड़ कैसा दिखता है।',
    feat9T: 'एक फ़ाइल यानी पूरा वंश-वृक्ष',
    feat9B: 'एक .zuying फ़ाइल यानी पूरा वंश-वृक्ष — तस्वीरें, रिकॉर्डिंग और कहानियाँ उसी में। AirDrop से किसी परिजन को भेजिए, उन्हें पूरी प्रति मिलेगी; फ़ाइल आपकी है, जहाँ चाहें रखिए।',
    ...
    regionsNowLabel: 'अभी उपलब्ध',
    regionsNow: 'iPhone पर 13 देशों और क्षेत्रों में: मुख्यभूमि चीन, हांगकांग, मकाऊ, ताइवान, अमेरिका, कनाडा, जापान, भारत, सिंगापुर, मलेशिया, इंडोनेशिया, फ़िलीपींस और थाईलैंड।',
    regionsNextLabel: 'आगे',
    regionsNext: 'Android संस्करण अभी क्लोज़्ड टेस्टिंग में है और उसके बाद Google Play पर आएगा, साथ ही ब्रिटेन, ऑस्ट्रेलिया और यूरोपीय संघ।',
    ctTitle: 'संपर्क करें',
    ctSub: 'सुझाव, विचार, या सबसे पहले आज़माना चाहते हैं? हमें ईमेल भेजें।',
    ctNote: 'हम हर संदेश पढ़ते हैं।',
    footer: '© 2026 Zuying · अपने परिवार की कहानी संजोएँ',
    styles: { soft: 'Soft Minimal', glass: 'Aurora Glass', candy: 'Warm Playful', paper: 'Heritage' },
  },
};
