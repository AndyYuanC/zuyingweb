...
const I18N = {
  zh: {
    ...
    dlTitle: '即将与你见面',
    dlSub: '祖影正在为 App Store 上架做最后准备，Android 版随后跟上。',
    ctTitle: '联系我们',
  ...
  zh_Hant: {
    ...
    dlTitle: '即將與你見面',
    dlSub: '祖影正在為 App Store 上架做最後準備，Android 版隨後跟上。',
    ctTitle: '聯絡我們',
  ...
  en: {
    ...
    dlSub: 'Zuying is in final preparation for the App Store; Android will follow.',
    ctTitle: 'Contact us',
  ...
  es: {
    ...
    dlSub: 'Zuying se prepara para llegar al App Store; la versión Android vendrá después.',
    ctTitle: 'Contacto',
  ...
  fr: {
    ...
    dlSub: 'Zuying se prépare pour l’App Store ; la version Android suivra.',
  ...
  hi: {
    ...
    dlSub: 'Zuying ऐप स्टोर के लिए आख़िरी तैयारी में है; Android इसके बाद आएगा।',
    ctTitle: 'संपर्क करें',
