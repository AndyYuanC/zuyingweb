...
const I18N = {
  zh: {
    ...
    regionsNext: 'Android 版正在封闭测试，之后上架 Google Play；地区上还会加英国、澳洲、印度和欧盟，中国大陆要等备案完成。',
    ctTitle: '联系我们',
  ...
  zh_Hant: {
    ...
    regionsNext: 'Android 版正在封閉測試，之後上架 Google Play；地區上還會加英國、澳洲、印度和歐盟，中國大陸要等備案完成。',
    ctTitle: '聯絡我們',
  ...
  en: {
    ...
    regionsNext: 'Android is in closed testing and heads to Google Play next, along with the UK, Australia, India and the EU; mainland China waits on its filing.',
    ctTitle: 'Contact us',
  ...
  es: {
    ...
    regionsNext: 'La versión para Android está en pruebas cerradas y llegará después a Google Play, junto con Reino Unido, Australia, India y la Unión Europea; China continental espera su registro.',
    ctTitle: 'Contacto',
  ...
  fr: {
    ...
    regionsNext: 'La version Android est en test fermé et arrivera ensuite sur Google Play, avec le Royaume-Uni, l’Australie, l’Inde et l’Union européenne ; la Chine continentale attend son enregistrement.',
  ...
  hi: {
    ...
    regionsNext: 'Android संस्करण अभी क्लोज़्ड टेस्टिंग में है और उसके बाद Google Play पर आएगा, साथ ही ब्रिटेन, ऑस्ट्रेलिया, भारत तथा यूरोपीय संघ; मुख्यभूमि चीन पंजीकरण की प्रतीक्षा में।',
    ctTitle: 'संपर्क करें',
