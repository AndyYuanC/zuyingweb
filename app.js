...
const I18N = {
  zh: {
    ...
    feat8T: '史册里的家族',
    feat8B: '内置六棵真实的家族树：孔子七十九代、伊丽莎白二世、肯尼迪、达尔文、梁启超，还有炎黄二帝。打开就知道一棵长成的树是什么样子。',
    feat9T: '一份文件，就是整棵树',
    ...
    regionsNowLabel: '现在',
    regionsNow: 'iPhone 版，已在美国、加拿大、港澳台、新加坡和马来西亚的 App Store 上架。',
  ...
  zh_Hant: {
    ...
    feat8T: '史冊裡的家族',
    feat8B: '內建六棵真實的家族樹：孔子七十九代、伊莉莎白二世、甘迺迪、達爾文、梁啟超，還有炎黃二帝。打開就知道一棵長成的樹是什麼樣子。',
    feat9T: '一份檔案，就是整棵樹',
    ...
    regionsNowLabel: '現在',
    regionsNow: 'iPhone 版，已在美國、加拿大、港澳台、新加坡和馬來西亞的 App Store 上架。',
  ...
  en: {
    ...
    feat8B: 'Six real family trees are built in: seventy-nine generations of Confucius, Elizabeth II, the Kennedys, the Darwins, Liang Qichao, and the legendary Yan and Yellow Emperors. Open one and see what a grown tree looks like.',
    ...
    regionsNowLabel: 'Now',
    regionsNow: 'On iPhone, in the US, Canada, Hong Kong, Taiwan, Macau, Singapore and Malaysia.',
  ...
  es: {
    ...
    feat8B: 'Seis árboles genealógicos reales vienen incluidos: setenta y nueve generaciones de Confucio, Isabel II, los Kennedy, los Darwin, Liang Qichao y los legendarios emperadores Yan y Amarillo. Abre uno y verás cómo es un árbol ya crecido.',
    ...
    regionsNowLabel: 'Ahora',
    regionsNow: 'En iPhone, en Estados Unidos, Canadá, Hong Kong, Taiwán, Macao, Singapur y Malasia.',
  ...
  fr: {
    ...
    feat8B: 'Six arbres généalogiques réels sont inclus : soixante-dix-neuf générations de Confucius, Élisabeth II, les Kennedy, les Darwin, Liang Qichao, et les légendaires empereurs Yan et Jaune. Ouvrez-en un pour voir à quoi ressemble un arbre déjà grand.',
    ...
    regionsNowLabel: 'Maintenant',
    regionsNow: 'Sur iPhone, aux États-Unis, au Canada, à Hong Kong, à Taïwan, à Macao, à Singapour et en Malaisie.',
  ...
  hi: {
    ...
    feat8B: 'छह असली वंशवृक्ष पहले से मौजूद हैं: कन्फ़्यूशियस की उन्यासी पीढ़ियाँ, एलिज़ाबेथ द्वितीय, केनेडी, डार्विन, लियांग छिचाओ, और पौराणिक यान तथा पीत सम्राट। एक खोलिए और देखिए कि पूरा बड़ा हुआ पेड़ कैसा दिखता है।',
    ...
    regionsNowLabel: 'अभी',
    regionsNow: 'iPhone पर — अमेरिका, कनाडा, हांगकांग, ताइवान, मकाऊ, सिंगापुर और मलेशिया में।',
